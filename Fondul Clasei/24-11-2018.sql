...
SELECT pg_catalog.setval('public.alexandru_cruceanu_sequence', 1, false);
...
SELECT pg_catalog.setval('public.andreea_maxim_sequence', 1, false);
...
SELECT pg_catalog.setval('public.andrei_popa_sequence', 1, true);
...
SELECT pg_catalog.setval('public.cheltuieli_sequence', 2, true);
...
SELECT pg_catalog.setval('public.miriam_ditu_sequence', 1, false);
...
SELECT pg_catalog.setval('public.monica_chedica_sequence', 1, true);
...
SELECT pg_catalog.setval('public.rares_cozma_sequence', 1, true);
...
SELECT pg_catalog.setval('public.stefan_spiridon_sequence', 1, true);
...
SELECT pg_catalog.setval('public.valentin_petrea_sequence', 1, false);
